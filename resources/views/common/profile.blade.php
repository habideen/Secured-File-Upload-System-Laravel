      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="/{{ (Session::get('account_type') == 'Admin')? 'admin':'user'}}/index">Home</a></li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row justify-content-between">
                      <form action="{{ (Session::get('account_type') == 'Admin')? route('admin.update_profile_passport') : route('user.update_profile_passport') }}" method="post" enctype="multipart/form-data" class="col-md-4 col-sm-5 forms-sample text-center">
                        @csrf
                      ...
                      <form action="{{ (Session::get('account_type') == 'Admin')? route('admin.update_profile') : route('user.update_profile') }}" 
                        method="post" class="col-md-6 col-sm-6 forms-sample">
                        @csrf
