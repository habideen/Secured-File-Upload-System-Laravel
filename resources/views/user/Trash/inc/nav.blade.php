    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/user/submit_coupon">
              <i class="mdi mdi-library-plus menu-icon"></i>
              <span class="menu-title">Submit new coupon</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/user/submitted_coupon">
              <i class="mdi mdi-playlist-check menu-icon"></i>
              <span class="menu-title">Submitted coupon</span>
            </a>
          </li>
          <li class="nav-item">
