        ...
        <div class="content-wrapper">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Submitted COupon</li>
            </ol>
          </nav>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
              <div class="card-body">
                <h4 class="card-title mb-5">Submitted Coupons</h4>
                  ...
                  <table id="table1" class="table">
                    ...
                    <tbody>
                      <tr>
                          ...
                          <td>5 Jan, 2022</td>
                          <td>
                          <button class="btn btn-outline-success process-submission" data-type="accept" data-id="23">Accept</button>
                          <button class="btn btn-outline-danger process-submission" data-type="decline" data-id="23">Danger</button>
                          </td>
                      </tr>
                      <tr>
                          <td>1</td>
