                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          <div>
                            <p class="statistics-title">Cleared</p>
                            <h3 class="rate-percentage">25</h3>
                          </div>
                          <div>
                            <p class="statistics-title">Pending</p>
                            <h3 class="rate-percentage">34</h3>
                          </div>
                          <div>
                            <p class="statistics-title">Amount</p>
                            <h3 class="rate-percentage">&#8358; 15,000</h3>
                          </div>
                          <div>
                            <p class="statistics-title">Last Signin</p>
                            <h3 class="rate-percentage">13 Jan, 2022</h3>
                          </div>
                        </div>
                      </div>
                    </div> 
