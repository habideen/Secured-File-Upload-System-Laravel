        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-md-8 text-white">
                    <h1 class="heading-1 font-weight-bold">Our Privacy Policy</h1>
                    <p class="mt-4 custom-breadcrumb"><a href="index.html">Home</a><span class="custom-break">/</span><span class="active">Private Policy</span></p>
                </div>
            </div>
        </div>
    </div>
